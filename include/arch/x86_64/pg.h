...
#define KERNEL_ACPI_BASE (KERNEL_BASE + (1 << 30))

#define KERNEL_DEFAULT_SIZE (1 << 13)
#define KERNEL_APIC_BASE (KERNEL_ACPI_BASE + KERNEL_DEFAULT_SIZE)
#define KERNEL_LAPIC_BASE KERNEL_APIC_BASE
#define KERNEL_IOAPIC_BASE (KERNEL_LAPIC_BASE + KERNEL_DEFAULT_SIZE)
